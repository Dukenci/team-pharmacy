...
func RegisterRoutes(router *gin.Engine, categoryService service.CategoryService, subcategoryService service.SubcategoryService, reviewService service.ReviewService, medicineService service.MedicineService) {
